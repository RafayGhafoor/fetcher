;if(CloudflareApps.matchPage(CloudflareApps.installs['y7fPMP7ACqY9'].URLPatterns)){(function(){"use strict"
if(!window.addEventListener)return
var options=CloudflareApps.installs['y7fPMP7ACqY9'].options
var element
...
if(("y7fPMP7ACqY9"==='preview')||((localStorageValid===false)||(localStorageValid===undefined))){for(var option in options){if(option===undefined)return false}
...
elementButton.onclick=function(){if("y7fPMP7ACqY9"!='preview'){element.style.display='none'
...
window.CloudflareApps.installs['y7fPMP7ACqY9'].scope={setOptions:function setOptions(nextOptions){options=nextOptions
